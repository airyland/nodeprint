...
if(! defined('NOT_FOUND_IMAGE') )		define ('NOT_FOUND_IMAGE', './avatar/default.png');								// Image to serve if any 404 occurs 
if(! defined('ERROR_IMAGE') )			define ('ERROR_IMAGE', './avatar/default.png');									// Image to serve if an error occurs instead of showing error message 
