...
const REDIRECT_URL = 'http://nodeprint.com/application/libraries/google/examples/analytics/demo/';
const CLIENT_ID = '982792199846.apps.googleusercontent.com';
const CLIENT_SECRET = 'mrqb3_erO8bhkCn08Dx4VcPv';
...
?>
    ...
    <ul>
      <li><a href="<?php echo $helloAnalyticsDemoUrl;?>">Hello Analytics API</a> &ndash;
      ...
      <li><a href="<?php echo $mgmtApiDemoUrl;?>">Management API Reference</a> &ndash;
          Traverse through the
          <a href="http://code.google.com/apis/analytics/docs/mgmt/v3/mgmtGettingStarted.html">
             Management API</a> and print all the important
          information returned from the API for each of the first entities.</li>

      <li><a href="<?php echo $coreReportingDemoUrl;?>">Core Reporting API Reference</a> &ndash;
